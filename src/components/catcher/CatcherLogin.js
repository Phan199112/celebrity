			...
			<View behavior='padding' style={styles.container}>
				...
				<View style={styles.container2}>
					...
					<View style={styles.remember}>
						...
						<TouchableOpacity style={{alignItems: 'flex-end'}} onPress={goToCatcherPassReset}>
					...
					<View style={styles.signup}>
						...
						<TouchableOpacity onPress={goToCatcherSignup} style={{borderBottomWidth: 1, borderBottomColor: '#7bdab8'}}>
...
const goToCatcherPassReset = () => {
	Actions.catcher_pass_reset()
}

const goToCatcherSignup = () => {
	Actions.to_catcher_signup()
}
