		...
		return(
			<View style={styles.container}>
				...
				<ImageBackground style={{}}
					...
					<NavBar style={{}}>
						<NavGroup style={{}}>
							<NavButton onPress={this.backHandler}>
				...
				<View style={styles.container2}>
					...
					<View style={styles.input}>
						<TouchableOpacity style={styles.styleTouchable} onPress={goToCatcherFollowers}>
					...
					<View style={styles.input}>
						...
						<TouchableOpacity style={styles.styleTouchable} onPress={goToCatcherFollowing}>
					...
					<View style={styles.input}>
						...
						<TouchableOpacity style={styles.styleTouchable} onPress={goToCelebrityFollowing}>
					...
					<View style={styles.input}>
						<TouchableOpacity style={styles.styleTouchable} onPress={goToCatcherPhotos}>
					...
					<View style={styles.input}>
						<TouchableOpacity style={styles.styleTouchable} onPress={goToActiveBidPhotos}>
					...
					<View style={styles.input}>
						<TouchableOpacity style={styles.styleTouchable} onPress={goToCatcherSoldPhotos}>
