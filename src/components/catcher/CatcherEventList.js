			...
			<View style={styles.container}>
				...
				<View style={styles.container1}>
					...
					<View style={styles.calendarView}>
						...
						<TouchableOpacity onPress={goToCatcherFindEvent}>
					...
					<TouchableOpacity onPress={goToCatcherEventDetail}>
...
const goToCatcherFindEvent = () => {
	Actions.catcher_find_event()
}

const goToCatcherEventDetail = () => {
	Actions.catcher_event_detail()
}
